...
'''
train_and_classify.py - train the Foxglovetree data and perform classification
'''
...
n_epochs = 50	# can be changed using sys.argv[2]
learning_rate = 0.03
momentum = 0.9
weight_decay = 1e-4
...
if torch.backends.mps.is_available(): device = torch.device('mps')	# can be changed using sys.argv[1]
